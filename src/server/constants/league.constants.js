export const LEAGUE_NAME = "English Premier League";

export const LEAGUE_DESCRIPTION = `
The Premier League, often referred to as the English Premier League
or the EPL (legal name: The Football Association Premier League Limited),
